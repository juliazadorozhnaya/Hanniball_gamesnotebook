...
import hanniball.ui.HanniballGamePanel;
...
//		addGoTab(gamesFolder);
	...
	private static void addKiHanniball(TabFolder folder) {
		TabItem tabItem = new TabItem(folder, SWT.NONE);
		tabItem.setControl(new HanniballGamePanel(folder));
		tabItem.setImage(smallIcon(HanniballImages.iconHanniball));
		tabItem.setText("Hanniball");		
	}
